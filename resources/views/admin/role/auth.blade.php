        ...
        <form class="layui-form" action="{{ url('admin/role/doauth')}}" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    ...
                    <input type="text" id="L_username" name="role_name" value="{{$role->role_name}}" required="" lay-verify=""
                ...
                <div class="layui-input-inline" style='width:600px'>
                    @foreach($perms as $v)
                        @if(in_array($v->id,$own_pers))
                            <input type="checkbox" name="permission_id[]" value="{{$v->id}}" title="{{$v->per_name}}" lay-skin="primary" checked>
                        @else
